...
# Load img3
img3_path = 'test1.jpg'  # Change this to the path of your img3
...
# Save img4 with the original filename and an underscore
img4_path = f'{filename}_.' + extension
img4.save(img4_path)

# Print the path of img4
print(f'img4 saved at: {img4_path}')
